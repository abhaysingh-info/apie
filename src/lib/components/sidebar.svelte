...
<section class="sidebar-root flex relative z-10">
	...
	<div
		class="sidebar z-50 border-r w-3/4 md:w-1/2 transition-all {$sidebarStore ? 'absolute top-0 bottom-0 bg-white translate-x-0' : 'hidden -translate-x-full lg:translate-x-0'} lg:w-16 lg:flex flex-col justify-start">
